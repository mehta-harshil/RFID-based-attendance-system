...
public class SignupActivity extends AppCompatActivity {
    ...
    private static final String BASE_URL = "https://rfid-based-attendance-system-production.up.railway.app/api/auth";
    ...
    private void addFilePart(DataOutputStream request, String boundary, String fieldName, Uri fileUri) throws Exception {
        ...
        // ✅ FIX: Get proper filename from cursor instead of URI path
        String filename = "logo.jpg"; // default fallback
        ...
        // ✅ FIX: Ensure filename has correct extension based on mimeType
        if (!filename.contains(".")) {
            String ext = android.webkit.MimeTypeMap.getSingleton()
                    .getExtensionFromMimeType(mimeType);
            if (ext != null) filename = "logo." + ext;
        }
